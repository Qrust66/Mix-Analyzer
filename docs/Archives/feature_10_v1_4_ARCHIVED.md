...
**Statut :** **Spec figée — dev en cours (F10a-F10g + F10g.5 livrés)**, F10h restant
...
### Total *(modifié en v1.4 — ajout F10g.5)*

**Effort total F10 :** 16-22h, ~50-65 tests + 1 smoke GUI, **18 micro-commits** (9 code + 9 tests, F10g.5 ajoute 2 commits via process change "spec bundled in test commit").
