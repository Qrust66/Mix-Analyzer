> **⚠️ ARCHIVÉ** — cette version (v1.1) a été remplacée par
> `docs/Features/feature_10_high_resolution_spectral_engine_v1_2.md`
> après validation utilisateur des Q1-Q6 le 2026-05-02. v1.2 figée
> pour démarrage dev (Phase F10a).
>
> Préservation intégrale de v1.1 ci-dessous pour traçabilité historique.
