...
| **2** | Motif-decider PROFOND (minimal first) | ~14h | ✅ Phase 2.7 + 2.7.1 audit-cleanup |
...
| 2.4 | Cohesion rules (motifs vs arrangement, structure) | ~1.5h | ✅ 2 BLOCK rules |
...
| 2.7 | Audit + Phase 2.7.1 cleanup | ~2h | ✅ 9 weaknesses → 9 forces |
| **+** | Bloc 3.1 wirage dynamics arc → velocity envelope | ~2h | ✅ embedded in 2.7.1 |
